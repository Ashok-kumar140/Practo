  ...
  return (
    <div className="flex items-center justify-between border-[1px] border-gray-200 rounded-lg p-2">
      <div className="flex items-center justify-center gap-3">
        ...
        <div>
          <p onClick={()=>naviagate(`/search/doctor/${doctor.id}`)} className="text-[#199fd9] text-xl underline hover:scale-105 transition-all duration-300 cursor-pointer">{doctor.name}</p>
